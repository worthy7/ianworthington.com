...
const translations = {
  en: {
    ...
    'hero.body': 'I partner with middle managers and frontline teams to replace manual workarounds, ghost spreadsheets, and outdated approval loops with practical automation that fits your current stack.',
    ...
    'pmp.body': 'PMP certification signals proven project leadership across scope, risk, quality, and stakeholder alignment. In practical terms, I help your team move from firefighting to predictable delivery with clear milestones, accountable ownership, and outcomes you can measure.',
    ...
    'profile.line1': 'I work directly with managers and frontline staff to map where work gets stuck, then fix those points with practical integrations and automation.',
    ...
    'features.body': 'Integration-first. Self-service by design. Built where your people already work.',
    ...
    'footer.tagline': 'I solve operational bottlenecks through practical consulting and solution delivery.'
  },
  ja: {
    ...
    'hero.body': '中間管理職と現場メンバーに伴走し、手作業の回避策、ゴーストスプレッドシート、古い承認ループを、既存環境に合う実用的な自動化へ置き換えます。',
    ...
    'profile.line1': '管理職と現場の両方と直接対話し、業務が詰まるポイントを可視化して、実用的な連携と自動化で解消します。',
    ...
    'features.body': '連携ファースト。セルフサービス設計。今の業務環境でそのまま動く。',
    ...
    'footer.tagline': '実務に寄り添うコンサルティングと実装で業務ボトルネックを解消。'
  }
};
